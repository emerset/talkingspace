...
<?php if ($topics) : ?>
<ul id="topics">
	<?php if (!is_array($topics)) { $topics = array($topics); } ?>
...
<ul>
	<li>Total Number of Users: <strong><?php echo $this->totalUsers ?></strong></li>
	<li>Total Number of Topics: <strong><?php echo $this->totalTopics ?></strong></li>
	<li>Total Number of Categories: <strong><?php echo $this->totalCategories ?></strong></li>
</ul>
